...
<div class="container">
    <h4>Bienvenido . {{ auth()->user()->name }} </h4>
        <div class="row">
            ...
            <div class="col-md-2">
                @can('tarea.create')
                <a href="{{ route('tarea.create') }}" ><img src="http://auditoria.damplus.net/iconos/create.png"></a>
                @endcan
            </div>
            <div class="col-md-4" >
            <b> Conectados... </b>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="alert alert-success" class="card-header" >
                   LISTADO DE  TAREAS 
                    <span align ="right">
                        <div id="auditor"></div>   
                    </span>
             ...
             <table class="table table-hover table-condensed">
                ...
                <tr >
                    ...
                    <td class='text-center'><small class="text-muted">{{ $tareas->plantilla->nombre }}</small></td>  
                    ...
                    <a id="tareay" href="{{ route('temp.index', $tareas->id) }}"> <img src="http://auditoria.damplus.net/iconos/trabajar.png" width="30" height="30">  <span class="badge badge-light">@foreach ($gestionestem->where('tarea_id',$tareas->id) as $gestionestems) {{ $gestionestems->gestion }}@endforeach</span></a> 
                    </button>
                ...
                <div class="ibox-content">
                    ...
                    <div class="m-t-sm">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <canvas id="cumplimiento" width="1000" height="1000" ></canvas>
                            </div>
                        </div>
                    </div>
                    <div class="m-t-md">
...
<script src="{{ asset('js/campalive.js') }}" ></script>
