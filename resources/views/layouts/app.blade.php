...
<meta charset="Content-Type:application/json">
    <meta charset="utf-8">
...
body {
        background-image: url("http://auditoria.damplus.net/fondos.jpg");
    }
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel " style="background-color: #e3f2fd;">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/') }}" style="background-color: #d7f3e3;">
                   <img src="http://auditoria.damplus.net/logo.jpg" alt="DatamarketingPlus">
                </a>
                </a>
